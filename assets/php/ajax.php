...
// function getSimilarUsers($target_user_id, $ratings, $similarity_threshold) {
//     $similarUsers = array();
//     $targetUserRatings = getUser($target_user_id, );

//     foreach ($ratings as $rating) {
//         $otherUserRatings = getUser($rating['user_id'], );
//         $similarity = ( $otherUserRatings);

//         if ($rating['user_id'] != $target_user_id && $similarity >= $similarity_threshold) {
//             $similarUsers[$rating['user_id']] = $similarity;
//         }
//     }
